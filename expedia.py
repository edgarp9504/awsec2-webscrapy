...
class ExpediaMX:
    ...
    def __init__(self):
        ...
        self.url        = "https://www.expedia.mx/Cancun-Hoteles-Temptation-Cancun-Resort-All-Inclusive-Adults-Only.h17310768.Informacion-Hotel"
    ...
    def extrac_info(self):
        ...
        dataset = {'nombre': [], 'conceptop': [], 'fecha_review' : [], 'critica' : [], 'review' : [], 'date_extract' : []}
